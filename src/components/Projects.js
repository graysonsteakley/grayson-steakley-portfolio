            ...
            <div className="row mx-3 mt-5">
                ...
                <div className="card text-up-anim bg-dark text-white col-sm-6 col-12">
                        ...
                        <div className="card-body">
                            ...
                            <p className="card-text">
                            Built a functional full-stack post site, that sends and receives data through an Apollo Graph-QL server to MongoDB. 
                            Users, posts, likes, and comments are are stored in the database. Client side data is moved through a seperate context Api store.
                            Apollo brings the back-end and client side structures together.                           
                            </p>
                        </div>
